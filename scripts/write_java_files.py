...
with open(f"{D}/RingtonePlugin.java", "w") as f:
    f.write(
        ...
        '        int toneDur = call.getInt("toneDuration", 10);\n'
        '        int vibDur = call.getInt("vibDuration", 60);\n'
        '        if (triggerAt <= 0) { call.reject("Missing triggerAt"); return; }\n'
        '        try {\n'
        '            getContext().getSharedPreferences("matchreport_alarm", Context.MODE_PRIVATE).edit().putInt("toneDuration", toneDur).putInt("vibDuration", vibDur).apply();\n'
        ...
        '        int toneSec = call.getInt("toneDuration", 5);\n'
        '        int vibSec = call.getInt("vibDuration", 10);\n'
        '        getContext().getSharedPreferences("matchreport_alarm", Context.MODE_PRIVATE)\n'
        '            .edit().putInt("tone_duration", toneSec).putInt("vib_duration", vibSec).apply();\n'
        '        call.resolve();\n'
        '    }\n\n'
        '    @PluginMethod\n'
